...
<body>
 ...
 %> 
		 <%
 			if(member.getM_email().equals("admin")){%>
 				<a href="MemberSelectAllCon.jsp">회원관리</a>
 ...
 <a href="update.jsp">개인정보수정</a> 
 <a href="Logout.jsp">로그아웃</a> <!-- 로그인 후 Logout.jsp로 이동할 수 있는'로그아웃'링크와 '개인정보수정'링크를 출력하시오. -->
		<%
		}
		%> </nav> </header>
			...
			<form action="MsgSendCon" method="post">
				<div class="field half first">
					<label for="name">Name</label> <input type="text" id="name"
						placeholder="보내는 사람 이름" name="name" />
				</div>
				<div class="field half">
					<label for="email">Email</label> <input type="text" id="email"
						placeholder="보낼 사람 이메일" name="email" />
				</div>
